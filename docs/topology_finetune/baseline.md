...
| [ ] | P1 | Edges duplicated across subgraphs | Partition edges into disjoint chunks before building subgraphs |
| [ ] | P1 | No gradient accumulation | Accumulate over N subgraphs before optimizer.step() |
